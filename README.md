...
Embedded system running real-time software (PREEMPT_RT Linux kernel) to show how MUTEX and POSIX threads work. Visual output using LEDs (3 x 16-bit shift register IC + SPI protocol) and an oscilloscope (X-Y mode).< /br>< /br>
